...
switchValueButton.addEventListener("click", () => {
  const tempFirst = firstSwitchValueInput.value;
  const tempSecond = secondSwitchValueInput.value;

  firstSwitchValueInput.value = tempSecond;
  secondSwitchValueInput.value = tempFirst;
